...
public class DownloadActivity extends DownloadBase {
    ...
    public void runService(View view) {
        ...
        case R.id.intent_service_button:
        	...
        	Intent intent = DownloadIntentService.makeIntent(DownloadActivity.this, handler, getUrlString());
        	startService(intent);
        ...
        case R.id.thread_pool_button:
            ...
            // returned from the makeIntent() factory method.
        	Intent intent1 = ThreadPoolDownloadService.makeIntent(DownloadActivity.this, handler, getUrlString());
